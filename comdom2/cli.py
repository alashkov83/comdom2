...
class Cli:
    ...
    def run(self):
        ...
        try:
            for t, c_mass_1, c_mass_2, r, n in self.app.trj_cycle(not hydr):
                print('++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
                if t is not None:
                    print('At t = {0:.3f} {1:s}'.format(t if t < 1000 else t / 1000, "ps" if t < 1000 else "ns"))
    ...
    def xvg_stat(self):
        ...
        print('++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\nStatistics:\n'
              ...
              'Quartiles: (25%) = {6:.3f} \u212b, (50%) = {7:.3f} \u212b, (75%) = {8:.3f} \u212b\n'
              '++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++'.format(
    ...
    def cluster_an(self):
        ...
        for n, cls_center in enumerate(xhist.flatten()):
            print('Cluster No {0:d}: {1:.1f} % points of the trajectory, '
